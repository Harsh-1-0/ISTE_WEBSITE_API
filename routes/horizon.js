...
import Event from "../models/horizon.model.js";
import checkRole from "../middleware/roleVerify.js";
import cloudinary from "../config/cloudinary.js";

const RouterHorizon = new express.Router();

RouterHorizon.get("/", async (req, res) => {
  try {
...
RouterHorizon.get("/:title", async (req, res) => {
  try {
...
RouterHorizon.delete("/:title", checkRole([1, 2]), async (req, res) => {
  try {
...
RouterHorizon.delete("/:title/gallery", async (req, res) => {
  try {
    const { title } = req.params;
