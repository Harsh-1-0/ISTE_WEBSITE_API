...
import Event from "../models/gravitas.model.js";
import checkRole from "../middleware/roleVerify.js";
import cloudinary from "../config/cloudinary.js";

const RouterGravitas = new express.Router();

RouterGravitas.get("/", async (req, res) => {
  try {
...
RouterGravitas.get("/:title", async (req, res) => {
  try {
...
RouterGravitas.delete("/:title", checkRole([1, 2]), async (req, res) => {
  try {
...
RouterGravitas.delete("/:title/gallery", async (req, res) => {
  try {
    const { title } = req.params;
